...
Identical to grace_perception_collect_data.py except build_pair_labels() skips
...
Usage:
  python grace_perception_collect_data_v2.py               # default: 3000/300/300 episodes
  python grace_perception_collect_data_v2.py --train 500   # quick smoke-test
...
def main():
    ...
    print("\nDone. Train with:")
    print("  python grace_perception_train_phase1.py --variant B --data gram_v2_data_v2")
    print("  python grace_perception_train_phase2.py --data gram_v2_data_v2 --phase1 trained_models/gram_v2/phase1/B/best.pt")
