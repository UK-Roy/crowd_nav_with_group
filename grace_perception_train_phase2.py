...
Usage:
  ...
  python grace_perception_train_phase2.py --phase1 trained_models/gram_v2/phase1/best.pt

  # From random init (slower convergence but valid):
  python grace_perception_train_phase2.py

  # Quick test run:
  python grace_perception_train_phase2.py --epochs 5 --phase1 trained_models/gram_v2/phase1/best.pt
...
from grace_perception_train_phase1 import (GroupPairDataset, weighted_bce,
...
def main():
    ...
    from grace_perception_train_phase1 import evaluate as evaluate_p1
