...
Usage:
  python grace_perception_train_phase1.py --variant B          # current recommended
  python grace_perception_train_phase1.py --variant A          # ablation baseline
  python grace_perception_train_phase1.py --variant B --epochs 5  # quick test
