...
TAGA: Group-Aware Tangent Navigation for Socially Compliant Robots
% \SR{TAGA: A Group-Aware Tangent Navigation Approach for Socially Compliant Robots}
}
...
\input{sections/tangent}
\input{sections/crowd-robot-experiment}
% \input{sections/results}
\input{sections/newRes}
