...
Usage:
  ...
  python grace_perception_visualize_detection.py --mode dbscan_vs_gram --out dbscan_fail.png
  python grace_perception_visualize_detection.py --mode phase_transition --out p1_fail.png
  python grace_perception_visualize_detection.py --idx 42 --out sample_42.png
  python grace_perception_visualize_detection.py --mode dbscan_vs_gram --gif --n-frames 6 --out compare.gif
  python grace_perception_visualize_detection.py --mode dbscan_vs_gram --split-gif --n-frames 6 --out split
...
VEL_SCALE  = 0.5             # pos+vel DBSCAN scale (matches grace_perception_eval_detection.py)
DBSCAN_EPS = 2.0             # optimal eps from grace_perception_eval_detection.py (pos+vel)
