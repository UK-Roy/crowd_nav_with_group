...
-----
  ...
  python gram_v2_train_phase3.py

  # With v2-trained Phase 2 checkpoint (no code changes needed):
  python gram_v2_train_phase3.py --phase2 trained_models/gram_v2/phase2_v2/best.pt

  # Quick smoke-test (5 epochs):
  python gram_v2_train_phase3.py --epochs 5 --no-cuda
